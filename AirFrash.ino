...
String header;
boolean daylightSaving = false; //false for winter, true for summer
int StartTime = 6;
int EndTime = 22;
...
void loop(){
  if (daylightSaving) { timeClient.setTimeOffset(7200); } else { timeClient.setTimeOffset(10800); }
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /12/on") >= 0) {
              ...
              if (header.indexOf("StartTime=") && header.indexOf("EndTime=")){
                ...
                if (isValidNumber(strStartParam) && isValidNumber(strEndParam)) 
                {
                  ...
                  else { Serial.print("Not Valid Hour!!!"); }
                  } 
                else  { Serial.println(isDigit(intStartParam)); } 
                }
            } 
            ...
            if (output12State=="off") {
              ...
              client.println("<p>Bypass Power:</p><p><button class=\"button button2\" onclick=\"ControlLinks('/12/off','BypassBTN');\"><div id=\"BypassBTN\">OFF</div></button></p>");
            } 
            if (daylightSaving) {
              ...
              client.println("<p>DayLight:</p><p><button class=\"button button2\" onclick=\"ControlLinks('/DayLight/off','DayBTN');\"><div id=\"DayBTN\">OFF</div></button></p>");
            } 
